...
for(i=1:genotypeFactor.card)
    if(genotypesToAlleles(i,1) == genotypesToAlleles(i,2))  genotypeFactor.val(i) = alleleFreqs(genotypesToAlleles(i,1))^2;
    else genotypeFactor.val(i) = 2*alleleFreqs(genotypesToAlleles(i,1))*alleleFreqs(genotypesToAlleles(i,2));
    end;
end;    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
end 